...
const StarredPage = () => {
    ...
    const { movies, starred, search, filterGenre, filterReleaseYear, filterRating } = movieState;
    ...
    const getData = () => {
        let movieData = starred.map(item => movies.find(({id})=>(item === id)));
    ...
    return <Layout>
        <div className='productspage-header'>
            <div className='productspage-headername'>Starred</div>
            <div>
