...
const WatchListPage = () => {
    ...
    const { movies, addToWatchList, search, filterGenre, filterReleaseYear, filterRating } = movieState;
    ...
    const getData = () => {
        let movieData = addToWatchList.map(item => movies.find(({id})=>(item === id)));
    ...
    return <Layout>
        <div className='productspage-header'>
            <div className='productspage-headername'>Watch List</div>
            <div>
